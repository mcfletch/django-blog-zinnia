        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Allows comments if checked.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Allows pingbacks if checked.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Allows trackbacks if checked.",
                        verbose_name="trackbacks enabled",
                    ),
                ),
                (
                    "comment_count",
                    models.IntegerField(default=0, verbose_name="comment count"),
                ),
                (
                    "pingback_count",
                    models.IntegerField(default=0, verbose_name="pingback count"),
                ),
                (
                    "trackback_count",
                    models.IntegerField(default=0, verbose_name="trackback count"),
                ),
                (
                    "excerpt",
                    models.TextField(
